...
const addOrder = (e) => {
  ...
  let payload = {
    ...
    final_quality_inspection: get(fields.value, '4.fieldgroup.0.fieldValue', ''),
    ...
    total_lead_time: get(fields.value, '10.fieldgroup.0.fieldValue', ''),
    final_inspection_photos: get(fields.value, '10.fieldgroup.1.fieldValue', ''),
    final_inspection_report: get(fields.value, '11.fieldgroup.0.fieldValue', ''),
    ...
    sample_inspection_photos: get(fields.value, '13.fieldgroup.0.fieldValue', ''),
    sample_inspection_report: get(fields.value, '13.fieldgroup.1.fieldValue', ''),
